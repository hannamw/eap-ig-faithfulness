...
node_iou_df = pd.read_csv('../jaccard/csv/node_ious.csv')
edge_iou_df = pd.read_csv('../jaccard/csv/edge_ious.csv')
...
fig.write_image(f'{model_name_noslash}/png/heatmaps.png')
fig.write_image(f'{model_name_noslash}/pdf/heatmaps.pdf')
fig.show()
# %%
heat1 = go.Heatmap(z=node_z,
                  x=display_names,
...
#fig['layout']['xaxis3']['title']='Tested on'
#fig['layout']['yaxis1']['title']=''
#fig['layout']['yaxis2']['title']=''
#fig['layout']['yaxis3']['title']='Circuit from'
fig.write_image(f'{model_name_noslash}/png/heatmaps_renormalized.png')
fig.write_image(f'{model_name_noslash}/pdf/heatmaps_renormalized.pdf')
fig.show()
# %%
# %%
